...
- **install/** - скрипты установки
    - Конфигурационные файлы поддерживают установку как через GNU Stow, так и через скрипт установки.
    - Пакеты устанавливаются через скрипт установки **или** вручную.
    - Вспомогательные скрипты и дополнительные утилиты устанавливаются **только** через установочные скрипты. Вы можете попытаться поставить их вручную, но я не советую.

- **assets** - используемые системой ресурсы: обои, изображения, иконки и другие статические файлы.
